...
def main():
    ...
    # [수정 1] 사이드바 폭 30mm(약 115px) 증가: 400px -> 450px
    st.markdown("""
        <style>
        ...
        .rest-card {
            background: white; border: 1px solid #ddd; border-radius: 10px; padding: 15px; height: 100%;
        ...
        .kakao-link {
            ...
            padding: 8px 0; border-radius: 5px; text-decoration: none; font-weight: bold; margin-top: 10px;
        }
        .reason-tag {
            background-color: #f1f3f5; color: #495057; padding: 2px 6px; border-radius: 4px; font-size: 0.8rem; margin-right: 4px;
        }
        </style>
    ...
    with st.sidebar:
        ...
        # 1. 현재 시간 및 날씨 표시
        # [수정 2] 시간 고정을 위한 session_state 초기화
        ...
        t = st.time_input("시간 선택", value=now.time())
